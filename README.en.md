...
Encyclopedia: [RU](https://st1ggy.github.io/veil/ru/) · [EN](https://st1ggy.github.io/veil/en/)
...
| Encyclopedia | `wiki/` | Markdown prose (Russian SoT) |
| EN mirror | `wiki/en/` | English articles for the site |
...
6. For the English site, add a mirror under `wiki/en/` with the same `id`
