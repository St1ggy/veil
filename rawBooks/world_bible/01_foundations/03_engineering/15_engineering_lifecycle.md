...
Жизненный цикл обеспечивает:

- воспроизводимость инженерной разработки;
- прослеживаемость изменений;
- безопасную эксплуатацию;
- управляемое развитие модели;
- накопление инженерного опыта;
- своевременное прекращение эксплуатации устаревших решений.
...
- существует ли уже подходящее инженерное решение;
- возможно ли использование существующей модели;
- требуется ли модификация существующей модели;
- действительно ли необходима разработка новой архитектуры.
...
- проверку статистической достоверности;
...
Подобная декомпозиция позволяет:

- упростить разработку;
- локализовать ошибки;
- повысить сопровождаемость;
- облегчить испытания;
- уменьшить вероятность каскадных отказов.
...
- полноту проектной документации;
- соответствие международным стандартам;
- отсутствие принципиальных противоречий;
- реализуемость предложенной архитектуры;
- достаточность предусмотренных мер безопасности.
...
- контроль полноты документации;
- проверку соблюдения внутренних процедур;
- регистрацию обнаруженных дефектов.
...
- поддержание работоспособности модели;
- устранение выявленных недостатков;
- повышение надёжности;
- адаптация к новым инженерным требованиям;
...
- анализ эксплуатационных журналов;
...
- идентифицировать конкретную реализацию модели;
...
Система управления рисками обеспечивает:

- своевременное выявление потенциальных угроз;
- предотвращение инженерных отказов;
- снижение вероятности аварий;
- уменьшение последствий возможных инцидентов;
- повышение общей устойчивости инженерной системы.
...
Разрабатывается специальная программа, включающая:

- прекращение эксплуатации;
- перевод пользователей на альтернативные решения;
- архивирование документации;
- регистрацию завершения жизненного цикла;
- обновление международных реестров.
...
Архивные материалы используются:

- для подготовки специалистов;
- для научных исследований;
- при разработке новых моделей;
- при анализе инженерной истории.
