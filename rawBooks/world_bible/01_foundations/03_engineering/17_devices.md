...
Требования к разработке устройств определяются совместно с документами:

- 13_etherological_engineering.md
- 14_standards_and_certification.md
- 15_engineering_lifecycle.md
...
В отличие от традиционных технических устройств, эфирологическое оборудование функционирует одновременно в двух взаимосвязанных средах:
...
Источником энергии могут быть:

- электрические сети;
- автономные энергетические установки;
- специализированные энергетические комплексы.
...
- соответствие нормативным ограничениям;
- аварийные ситуации.
...
Преимуществами модульной архитектуры являются:
...
Локализация обеспечивает:

- безопасную остановку устройства;
- сохранность данных;
- снижение масштаба аварий;
...
- автоматизация промышленной инфраструктуры.
...
- обмена эксплуатационной информацией;
- синхронизации устройств;
- удалённого управления;
- передачи диагностических данных;
- интеграции в распределённую инфраструктуру.
...
- предоставление оператору необходимой информации;
- ввод управляющих команд;
- предупреждение об опасных режимах;
...
Такие интерфейсы используются:

- автоматизированными системами управления;
- инженерными комплексами;
...
- едиными протоколами;
- унифицированными интерфейсами;
- согласованными алгоритмами обмена информацией;
- едиными требованиями к моделям взаимодействия.
...
- объединять оборудование в распределённые комплексы;
...
Во время самодиагностики контролируются:

- состояние компонентов;
- корректность работы датчиков;
- параметры модели взаимодействия;
- работоспособность управляющей системы;
- функционирование защитных механизмов.
...
- полную разборку устройства;
- проверку всех компонентов;
- замену изношенных элементов;
- повторные испытания;
- повторную сертификацию при необходимости.
...
- в небольших инженерных комплексах;
- автономных производственных системах;
...
Координационный уровень обеспечивает:
...
- выполнение сервисного обслуживания.
...
Конфигурация включает сведения о:

- составе модулей;
- версии программного обеспечения;
- версии модели взаимодействия;
- установленных обновлениях;
...
- снижать стоимость эксплуатации;
- сокращать сроки внедрения новых решений.
