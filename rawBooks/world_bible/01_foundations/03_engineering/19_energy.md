...
Эфирологические источники позволяют:

- значительно повысить плотность энергии;
- уменьшить потери при преобразовании;
- создавать компактные энергетические установки;
- обеспечивать питание сложных инженерных комплексов.
...
Комбинирование различных технологий позволяет:

- повысить надёжность;
- уменьшить эксплуатационные расходы;
- снизить влияние локальных отказов;
- увеличить эффективность использования ресурсов;
- повысить устойчивость энергетической сети.
...
Преобразующие установки обеспечивают:

- изменение формы энергии;
- изменение параметров потока;
- согласование различных инженерных систем;
...
- компенсировать пиковые нагрузки;
- использовать резервные мощности;
- обеспечивать автономную работу;
- стабилизировать энергетические сети;
- поддерживать аварийные режимы.
...
Такие системы обладают:

- высокой скоростью отдачи энергии;
- ограниченной ёмкостью;
- большим количеством рабочих циклов.
...
- резервных энергетических центрах;
- автономных инженерных комплексах.
...
Магистральные сети обладают:

- высокой пропускной способностью;
- развитой системой резервирования;
- автоматическим контролем состояния;
- средствами аварийной коммутации.
...
В первую очередь обеспечиваются энергией:
...
- непрерывное поддержание параметров;
...
Для уменьшения потерь используются:

- современные материалы;
- эффективные преобразователи;
- оптимальные режимы работы;
- сокращение количества промежуточных преобразований;
- автоматическое управление энергетическими потоками.
...
- оценку эффективности эксплуатации.
...
- постепенном износе оборудования;
...
- преобразование формы энергии;
- изменение характеристик потока;
- согласование различных инженерных систем;
- повышение эффективности передачи.
...
- обеспечение автономной работы объектов.
...
Сочетание различных технологий позволяет:

- повысить устойчивость;
- уменьшить стоимость эксплуатации;
- увеличить автономность;
- использовать преимущества каждой технологии.
...
- обмен избыточной мощностью;
- поддержка при чрезвычайных ситуациях;
- обеспечение международных инфраструктурных проектов.
