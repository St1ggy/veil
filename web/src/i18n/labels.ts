...
const entityTypes: Dict = {
  ...
  concept: { ru: "концепт", en: "концепт" },
  meta: { ru: "мета", en: "мета" },
  edge: { ru: "Черта", en: "Черта" },
  hindrance: { ru: "Помеха", en: "Помеха" },
  ...
  power_design: { ru: "дизайн силы", en: "дизайн силы" },
  setting_rule: { ru: "правило сеттинга", en: "правило сеттинга" },
...
const relations: Dict = {
  ...
  successor_of: { ru: "преемник", en: "преемник" },
  caused_by: { ru: "причина", en: "причина" },
