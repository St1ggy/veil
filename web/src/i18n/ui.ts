...
const ui = {
  ru: {
    ...
    gameLead:
      "Setting Book SDK: создание персонажа, Edges, правила сеттинга и play-каталоги. Без перепечатки core SWADE и без GM-секретов.",
    gameSectionsTitle: "Разделы SDK",
  ...
  en: {
    ...
    gameLead:
      "Setting Book SDK: character creation, Edges, setting rules, and play catalogs. No SWADE core reprint and no GM secrets.",
    gameSectionsTitle: "SDK sections",
    gameEmpty: "No published entries in this section yet.",
    gameItems: "entries",
    gameBack: "Back to play layer",
    gameSource: "Source",
    gameNotes: "Design notes",
    gameRelatedLore: "Related lore",
