...
- Network Mages
- Сетевые маги
summary: 'Практики работы с Мёртвым Интернетом и информационными следами Эфира: данные,
  память мест, остатки ИИ, старые сети.'
importance: major
spoilers: none
visibility: public
relations:
...
> Статья синхронизирована с канонической книгой `rawBooks/world_bible/01_foundations/03_engineering/18_infrastructure.md`.
