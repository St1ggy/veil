...
- Null Fields
- Нулевые поля
summary: Антимагические / стабилизационные технологии, используемые Эгидой для снижения
  Распада и контроля Эфира.
importance: major
spoilers: none
visibility: public
relations:
...
> Статья синхронизирована с канонической книгой `rawBooks/world_bible/01_foundations/03_engineering/17_devices.md`.
...
Требования к разработке устройств определяются совместно с документами `13_etherological_engineering.md`, `14_standards_and_certification.md` и `15_engineering_lifecycle.md`.
