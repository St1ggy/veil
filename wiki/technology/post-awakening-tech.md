---
id: TECH_POST_AWAKENING
type: technology
title: Постпробужденческие технологии
status: approved
version: 1
created: '2026-07-29'
updated: '2026-07-29'
...
- technology
aliases:
- Post-Awakening Technology
summary: Электричество, ИИ, роботы, железные дороги, заводы, дата-центры, огнестрел,
  дроны, авиация — существуют, но поддерживать их крайне сложно.
importance: core
spoilers: none
visibility: public
relations:
...
> Статья синхронизирована с канонической книгой `rawBooks/world_bible/01_foundations/03_engineering/13_etherological_engineering.md`.
